class Serie {
  ...
  /// Supprime les balises HTML présentes dans le résumé TVMaze
  /// comme <p>, <b>, <i>, etc.
  ...
  factory Serie.fromJson(Map<String, dynamic> json) {
    ...
    return Serie(
      ...
      // TVMaze utilise 'summary' avec du HTML, notre toJson() utilise 'synopsis'.
      synopsis: json['summary'] != null
          ? _stripHtml(json['summary'] as String?)
          : (json['synopsis'] as String? ?? ''),
      // TVMaze utilise 'genres' en liste, notre toJson() utilise 'genre' en String.
      genre: genres != null && genres.isNotEmpty
          ? genres[0] as String
          : (json['genre'] as String? ?? 'Inconnu'),
      // TVMaze : json['image']['medium'] ; stockage interne : imageUrl.
      imageUrl: (json['image']?['medium'] as String?) ?? (json['imageUrl'] as String?),
      // TVMaze : json['rating']['average'] ; stockage interne : note.
